...
const Geography = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* 1. BACKGROUND IMAGE (Ayaz-qala.jpg) */}
      <div className="absolute inset-0 z-0">
        <img 
          src="/images/Ayaz-qala.jpg" 
          alt="Ayaz Qala" 
          className="w-full h-full object-cover"
        />
        {/* Қараңғылатыў қабаты (Текст оқылыўы ушын) */}
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto text-white animate-fade-in-up">
        ...
        <div className="flex justify-center mb-6">
          <div className="p-4 rounded-full bg-white/10 border border-white/20 backdrop-blur-md shadow-xl">
            <Hammer size={48} className="text-yellow-400 animate-pulse" />
          </div>
        </div>
        ...
        {/* Прогресс бар (Декорация) */}
        <div className="mt-12 w-full max-w-md mx-auto h-2 bg-white/20 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-blue-500 via-purple-500 to-yellow-500 animate-loading-bar w-2/3"></div>
        </div>
