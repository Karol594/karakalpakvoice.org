...
const DigitalHeritage = () => {
  ...
  const translations = {
    KK: { title: "Жақын күнлерде иске қосамыз", desc: "Ҳәзир актив ислениўде. Күтип турыңыз!", label: "Санлы Мийрас" },
    RU: { title: "Запустим в ближайшие дни", desc: "Сейчас в активной разработке. Ожидайте!", label: "Цифровое Наследие" },
    EN: { title: "Coming Soon", desc: "Currently under active development. Stay tuned!", label: "Digital Heritage" },
    PL: { title: "Wkrótce uruchomimy", desc: "Obecnie w trakcie aktywnego rozwoju. Proszę czekać!", label: "Cyfrowe Dziedzictwo" }
  };
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img src="/images/digital.png" alt="Digital Heritage" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto text-white animate-fade-in-up">
        ...
        <div className="inline-block px-4 py-1 mb-4 text-sm font-bold uppercase tracking-widest bg-cyan-600/80 rounded-full border border-cyan-400/30">
          {t.label}
        </div>
        ...
        <div className="mt-12 w-full max-w-md mx-auto h-2 bg-white/20 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 animate-loading-bar w-2/3"></div>
        </div>
      </div>
       <style>{`
