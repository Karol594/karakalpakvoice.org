...
const Tourism = () => {
  ...
  const translations = {
    KK: { title: "Жақын күнлерде иске қосамыз", desc: "Ҳәзир актив ислениўде. Күтип турыңыз!", label: "Туризм" },
    RU: { title: "Запустим в ближайшие дни", desc: "Сейчас в активной разработке. Ожидайте!", label: "Туризм" },
    EN: { title: "Coming Soon", desc: "Currently under active development. Stay tuned!", label: "Tourism" },
    PL: { title: "Wkrótce uruchomimy", desc: "Obecnie w trakcie aktywnego rozwoju. Proszę czekać!", label: "Turystyka" }
  };
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto text-white animate-fade-in-up">
        <div className="flex justify-center mb-6">
          <div className="p-4 rounded-full bg-white/10 border border-white/20 backdrop-blur-md shadow-xl">
            <Map size={48} className="text-yellow-400 animate-pulse" />
          </div>
        </div>
        <div className="inline-block px-4 py-1 mb-4 text-sm font-bold uppercase tracking-widest bg-yellow-600/80 rounded-full border border-yellow-400/30">
          {t.label}
        </div>
        ...
        <div className="mt-12 w-full max-w-md mx-auto h-2 bg-white/20 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 animate-loading-bar w-2/3"></div>
        </div>
      </div>
       <style>{`
