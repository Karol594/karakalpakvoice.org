            ...
            <div className="space-y-4 text-[13px]">
              ...
              <div className="pt-6 border-t border-gray-800 mt-4">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  <a href="https://www.facebook.com/share/1MdM64ngQD/" className="p-2.5 rounded-full bg-[#1877F2] text-white hover:scale-110 transition"><Facebook size={18}/></a>
                  ...
                  <a href="https://www.instagram.com/karakalpakvoice_org?igsh=Y2x3YTJjMHdnM2Js" className="p-2.5 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600 text-white hover:scale-110 transition"><Instagram size={18}/></a>
                  <a href="https://youtube.com/@karakalpakvoice_org?si=oex6R1cS1NRcHAW-" className="p-2.5 rounded-full bg-[#FF0000] text-white hover:scale-110 transition"><Youtube size={18}/></a>
