src/components/Navigation.jsx ишинде 186 жол код бар ↓  
...
export default function Navigation() {  
  ...
  // Мобиль менюди жабыў (бетке өткенде)  
  useEffect(() => {  
    setIsOpen(false);  
  }, [location]);  
  ...
  const navLinks = [  
    { path: '/', label: 'Бас бет' },  
    { path: '/about', label: 'Биз тўуралы' },  
    { path: '/news', label: 'Жаңалықлар' },  
    { path: '/sovereignty', label: 'Суверенитет' },  
    { path: '/history', label: 'Тарийх' },  
    { path: '/geography', label: 'География' },  
    { path: '/people', label: 'Тулғалар' },  
    { path: '/tradition', label: 'Дәстүр' },  
