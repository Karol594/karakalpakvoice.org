export default function Hero() {
  return (
    <section
      ...
      style={{ backgroundImage: "url('https://images.unsplash.com/photo-1559827260-dc66d52bef19?q=80&w=1920')" }}
    >
...
### **1️⃣ GitHub-та Hero.jsx ашу**
### **2️⃣ Edit басу (📝)**
### **3️⃣ БАРЛЫҚ КОДТЫ ӨШІРУ**
### **4️⃣ ЖОҒАРЫДАҒЫ 22 ЖОЛ КОДТЫ КӨШІРІП ҚОЮ**
### **5️⃣ Commit changes**
...
## 💾 **COMMIT MESSAGE:**
```
Update Hero.jsx - karakalpakvoice.org media site
